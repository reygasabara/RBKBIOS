...
class SendPencegahanResikoPasienJatuh extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:pencegahan-resiko-pasien-jatuh';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan upaya pencegahan resiko pasien jatuh	...';
    ...
    public function handle()
    {
        ...
        $datas = IktPencegahanRisikoPasienJatuh::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_upaya_pencegahan_risiko_pasien_jatuh', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh')->firstOrFail();
