...
class ALOSController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layers.alos.index',["datas"=>$datas, 'active'=>['layanan', 'alos'], "updated"=>$updated, "lastUpdate"=>$lastUpdate]);
    }
    ...
    {
        return view('layers.alos.form',['active'=>['layanan', 'alos']]);
    }
