...
class SendJumlahPasienRanap extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-pasien-ranap';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah pasien rawat inap...';
    ...
    public function handle()
    {
        ...
        $datas = LayananJumlahPasienRanap::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/pasien_ranap', $data);
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Pasien Rawat Inap')->firstOrFail();
