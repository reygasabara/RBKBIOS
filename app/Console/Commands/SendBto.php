...
class SendBto extends Command
{
    ...
    public function handle()
    {
        ...
        $datas = LayananBTO::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/bto', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Bed Turn Over (BTO)';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Bed Turn Over (BTO)')->firstOrFail();
