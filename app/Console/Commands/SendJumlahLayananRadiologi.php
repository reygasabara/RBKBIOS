...
use App\Models\LayananRadiologi;
use Carbon\Carbon;
...
class SendJumlahLayananRadiologi extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-layanan-radiologi';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah layanan radiologi ...';
    ...
    public function handle()
    {
        ...
        $datas = LayananRadiologi::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/radiologi', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Jumlah Layanan Radiologi';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Layanan Radiologi')->firstOrFail();
