    ...
    <section class="content">
        <div class="box" style="position: relative">
            <div class="box-header with-border">
                <h3 class="box-title">Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU</h3>
                <div class="box-tools">
                    <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-btn">
                            <a href="/pertumbuhan-pendapatan-pengelolaan-aset-blu/input" class="btn btn-success">Input</a>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="col-sm-9" style="translate: 15px;">
                        <h6 class="text-right">
                            <strong><em>*Data dikirimkan per periode semesteran (tidak bersifat akumulatif)</em></strong>
                        </h6>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($datas as $key => $data)
                            <tr>
                                ...
                                <td>{{ $data['jumlah'] }}</td>
                                <td><a href="pertumbuhan-pendapatan-pengelolaan-aset-blu/delete/{{ $data['id'] }}"
