...
class JumlahLayananLaboratoriumParameterController extends Controller
{
    ...
    public function index()
    {
        ...
        $dataLabParameter = Http::withHeaders(['token' => $token])->post('https://training-bios2.kemenkeu.go.id/api/get/data/kesehatan/layanan/laboratorium_detail');
    ...
    public function store(Request $request)
    {
       ...
       $getToken = Http::post('https://training-bios2.kemenkeu.go.id/api/token',[
        ...
        $response = Http::withHeaders(['token' => $token])->post('https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/layanan/laboratorium_detail', $validatedData);
