...
class SendJumlahPasienBpjsNonBpjs extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-pasien-bpjs-non-bpjs';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah pasien BPJS dan non-BPJS ...';
    ...
    public function handle()
    {
        ...
        $datas = LayananPasienBPJSNonBPJS::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Jumlah Pasien BPJS/Non-BPJS';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Pasien BPJS/Non-BPJS')->firstOrFail();
