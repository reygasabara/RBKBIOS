...
class SendFisioterapis extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:fisioterapis';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah fisioterapis ...';
    ...
    public function handle()
    {
        ...
        $datas = SdmFisioterapis::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/sdm/fisioterapis', $data);
            ...
            $log->modul = 'SDM';
            $log->jenis_data = 'Jumlah Fisioterapis';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Fisioterapis')->firstOrFail();
