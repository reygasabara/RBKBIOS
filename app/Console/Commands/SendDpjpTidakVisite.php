...
class SendDpjpTidakVisite extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:dpjp-tidak-visite';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah DPJP tidak visite ...';
    ...
    public function handle()
    {
        ...
        $datas = IktDpjpTidakVisite::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/dpjp_non_visite', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Jumlah DPJP Tidak Visite';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah DPJP Tidak Visite')->firstOrFail();
