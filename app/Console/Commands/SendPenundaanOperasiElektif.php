...
class SendPenundaanOperasiElektif extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:penundaan-operasi-elektif';
     ...
     * @var string
     */
    protected $description = 'Mengirim data penundaan operasi elektif...';
    ...
    public function handle()
    {
        ...
        $datas = IktPenundaanOperasiElektif::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/penundaan_operasi_elektif', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Penundaan Operasi Elektif';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Penundaan Operasi Elektif')->firstOrFail();
