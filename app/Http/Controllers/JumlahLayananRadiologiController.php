...
class JumlahLayananRadiologiController extends Controller
{
    ...
    {
        $datas = LayananRadiologi::orderBy('updated_at', 'desc')->get();
        ...
        return view('layers.jumlah-layanan-radiologi.index',["datas"=>$datas, 'active'=>['layanan', 'radiologi'], "updated"=>$updated, "lastUpdate"=>$lastUpdate]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $checkedData = LayananRadiologi::Where('tgl_transaksi', $validatedData['tgl_transaksi'])->first();
        $status = $checkedData ? 'update' : 'add';

        if ($status == 'add') {
            $data = new LayananRadiologi();
            ...
            $updatedData = LayananRadiologi::where('tgl_transaksi', $validatedData['tgl_transaksi'])->firstOrFail();
        ...
        return Redirect::to('/layanan-radiologi');
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(LayananRadiologi $id)
    {
        $id->delete();
