...
class SendKepatuhanWaktuVisiteDokter extends Command
{
     ...
     * @var string
     */
    protected $signature = 'send:kepatuhan-penggunaan-fornas';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan penggunaan formularium nasional...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepatuhanPenggunaanFornas::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_penggunaan_fornas', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Penggunaan Formularium Nasional';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Penggunaan Formularium Nasional')->firstOrFail();
