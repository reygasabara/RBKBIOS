...
class SendRasioPobo extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:rasio-pobo';
     ...
     * @var string
     */
    protected $description = 'Mengirim data rasio POBO ...';
    ...
    public function handle()
    {
        ...
        $datas = IktRasioPobo::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/rasio_pobo', $data);
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Rasio POBO')->firstOrFail();
