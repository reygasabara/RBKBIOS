    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Form Kepatuhan Waktu Visite DPJP</h3>
            </div>

            <form role="form" method="POST" action="/kepatuhan-waktu-visite-dpjp/submit">
                @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{ old('jumlah') }}" id="jumlah" name="jumlah"
                            placeholder="Masukkan persentase waktu kepatuhan" required>
                    </div>
                </div>
