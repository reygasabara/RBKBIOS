...
class SendSaldoOperasional extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:saldo-operasional';
     ...
     * @var string
     */
    protected $description = 'Mengirim data saldo rekening operasional (keuangan)...';
    ...
    public function handle()
    {
        ...
        $datas = SaldoOperasional::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/keuangan/saldo/saldo_operasional', $data);
            ...
            $log->modul = 'Keuangan';
            $log->jenis_data = 'Saldo Rekening - Operasional';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Saldo Rekening - Operasional')->firstOrFail();
