...
class SendBor extends Command
{
     ...
     * @var string
     */
    protected $description = 'Mengirim data BOR ...';
    ...
    public function handle()
    {
        ...
        $datas = LayananBOR::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/bor', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Bed Occupancy Ratio (BOR)';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Bed Occupancy Ratio (BOR)')->firstOrFail();
