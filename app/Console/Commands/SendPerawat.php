...
class SendPerawat extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:perawat';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah perawat ...';
    ...
    public function handle()
    {
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/sdm/perawat', $data);
            ...
            $log->modul = 'SDM';
            $log->jenis_data = 'Jumlah Tenaga Perawat';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Tenaga Perawat')->firstOrFail();
