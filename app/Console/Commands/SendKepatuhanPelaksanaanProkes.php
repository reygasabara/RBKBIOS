...
class SendKepatuhanPelaksanaanProkes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:kepatuhan-pelaksanaan-prokes';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan pelaksanaan protokol kesehatan...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepatuhanPelaksanaanProkes::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_pelaksanaan_prokes', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Pelaksanaan Protokol Kesehatan';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Pelaksanaan Protokol Kesehatan')->firstOrFail();
