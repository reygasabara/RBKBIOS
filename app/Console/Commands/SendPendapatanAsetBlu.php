...
class SendPendapatanAsetBlu extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:pendapaatan-aset-blu';
     ...
     * @var string
     */
    protected $description = 'Mengirim data pertumbuhan realisasi pendapatan dari pengelolaan aset BLU...';
    ...
    public function handle()
    {
        ...
        $datas = IktPendapatanAsetBlu::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/pertumbuhan_realisasi_pendapatan_pengelolaan_aset_blu', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Pertumbuhan Realisasi Pendapatan dari Pengelolaan Aset BLU')->firstOrFail();
