...
class JumlahLayananFarmasiController extends Controller
{
    ...
    {
        $datas = LayananFarmasi::orderBy('updated_at', 'desc')->get();
        ...
        return view('layers.jumlah-layanan-farmasi.index',["datas"=>$datas, 'active'=>['layanan', 'farmasi'], "updated"=>$updated, "lastUpdate"=>$lastUpdate]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $checkedData = LayananFarmasi::Where('tgl_transaksi', $validatedData['tgl_transaksi'])->first();
        $status = $checkedData ? 'update' : 'add';

        if ($status == 'add') {
            $data = new LayananFarmasi();
            ...
            $updatedData = LayananFarmasi::where('tgl_transaksi', $validatedData['tgl_transaksi'])->firstOrFail();
        ...
        return Redirect::to('/layanan-farmasi');
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(LayananFarmasi $id)
    {
        $id->delete();
