...
class SendBidan extends Command
{
    ...
    public function handle()
    {
        ...
        $datas = SdmBidan::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $log->modul = 'SDM';
            $log->jenis_data = 'Jumlah Tenaga Bidan';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Tenaga Bidan')->firstOrFail();
