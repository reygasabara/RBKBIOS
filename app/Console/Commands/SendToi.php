...
class SendToi extends Command
{
     ...
     * @var string
     */
    protected $description = 'Mengirim data TOI ...';
    ...
    public function handle()
    {
        ...
        $datas = LayananTOI::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/toi', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Turn Over Interval (TOI)';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Turn Over Interval (TOI)')->firstOrFail();
