...
class SendDokterSpesialis extends Command
{
    ...
    public function handle()
    {
        ...
        $datas = SdmDokterSpesialis::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $log->modul = 'SDM';
            $log->jenis_data = 'Jumlah Dokter Spesialis';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Dokter Spesialis')->firstOrFail();
