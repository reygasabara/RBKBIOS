...
class SendKepatuhanKebersihanTangan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:kepatuhan-kebersihan-tangan';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan kebersihan tangan...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepatuhanKebersihanTangan::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_kebersihan_tangan', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Kebersihan Tangan';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Kebersihan Tangan')->firstOrFail();
