...
class SendJumlahLayananFarmasi extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-layanan-farmasi';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah layanan farmasi';
    ...
    public function handle()
    {
        ...
        $datas = LayananFarmasi::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/farmasi', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Jumlah Layanan Farmasi';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Layanan Farmasi')->firstOrFail();
