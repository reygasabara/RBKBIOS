...
class SendWaktuTungguRalan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:waktu-tunggu-ralan';
     ...
     * @var string
     */
    protected $description = 'Mengirim data waktu tunggu rawat jalan...';
    ...
    public function handle()
    {
        ...
        $datas = IktWaktuTungguRawatJalan::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/waktu_tunggu_ralan', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Waktu Tunggu Rawat Jalan';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Waktu Tunggu Rawat Jalan')->firstOrFail();
