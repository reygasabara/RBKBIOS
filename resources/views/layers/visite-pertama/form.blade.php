    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Form Jumlah Kegiatan Visite Pasien Pertama</h3>
            </div>

            <form role="form" method="POST" action="/visite-pertama/submit">
                @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{ old('jumlah') }}" id="jumlah" name="jumlah"
                            placeholder="Masukkan jumlah visite" required>
                    </div>
                </div>
