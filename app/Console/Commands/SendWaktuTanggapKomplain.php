...
class SendWaktuTanggapKomplain extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:waktu-tanggap-komplain';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kecepatan waktu tanggap komplain ...';
    ...
    public function handle()
    {
        ...
        $datas = IktWaktuTanggapKomplain::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kecepatan_waktu_tunggu_komplain', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kecepatan Waktu Tanggap Komplain';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kecepatan Waktu Tanggap Komplain')->firstOrFail();
