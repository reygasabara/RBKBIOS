...
class SendIKM extends Command
{
     ...
     * @var string
     */
    protected $description = 'Mengirim data idneks kepuasan masyarakat';
    ...
    public function handle()
    {
        ...
        $datas = LayananIKM::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/ikm_kesehatan', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Indeks Kepuasan Masyarakat (IKM)';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Indeks Kepuasan Masyarakat (IKM)')->firstOrFail();
