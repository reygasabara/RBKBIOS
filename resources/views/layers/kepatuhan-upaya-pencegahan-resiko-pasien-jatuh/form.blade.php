    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Form Kepatuhan Upaya Pencegahan Resiko Pasien Jatuh</h3>
            </div>

            <form role="form" method="POST" action="/kepatuhan-upaya-pencegahan-resiko-pasien-jatuh/submit">
                @csrf
