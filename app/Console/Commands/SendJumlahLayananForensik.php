...
class SendJumlahLayananForensik extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-layanan-forensik';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah layanan forensik ...';
    ...
    public function handle()
    {
        ...
        $datas = LayananForensik::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/forensik', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Jumlah Layanan Forensik';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Layanan Forensik')->firstOrFail();
