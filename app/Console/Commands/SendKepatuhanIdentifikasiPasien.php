...
class SendKepatuhanIdentifikasiPasien extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:kepatuhan-identifikasi-pasien';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan identifikasi pasien...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepatuhanIdentifikasiPasien::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_identifikasi_pasien', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Identifikasi Pasien';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Identifikasi Pasien')->firstOrFail();
