...
class IndeksKepuasanMasyarakatController extends Controller
{
    ...
    public function index()
    {
        ...
        $dataIKM = Http::withHeaders(['token' => $token])->post('https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/layanan/ikm_kesehatan');
    ...
    public function store(Request $request)
    {
       ...
       $getToken = Http::post('https://training-bios2.kemenkeu.go.id/api/token',[
        ...
        $response = Http::withHeaders(['token' => $token])->post('https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/layanan/ikm_kesehatan', $validatedData);
