...
class JumlahDokterUmumController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layers.jumlah-dokter-umum.index',["datas"=>$dokterUmum['datas'], 'active'=>'dokter_umum', 'savedData' => session('savedData')]);
    }
    ...
    {
        return view('layers.jumlah-dokter-umum.form',['active'=>'dokter_umum']);
    }
