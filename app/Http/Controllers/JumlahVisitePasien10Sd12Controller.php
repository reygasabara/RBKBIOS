...
class JumlahVisitePasien10Sd12Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $dataVisite = Http::withHeaders(['token' => $token])->post('https://training-bios2.kemenkeu.go.id/api/get/data/kesehatan/ikt/visite_2');
    ...
    public function store(Request $request)
    {
       ...
       $getToken = Http::post('https://training-bios2.kemenkeu.go.id/api/token',[
        ...
        $response = Http::withHeaders(['token' => $token])->post('https://training-bios2.kemenkeu.go.id/api/ws/kesehatan/ikt/visite_2', $validatedData);
