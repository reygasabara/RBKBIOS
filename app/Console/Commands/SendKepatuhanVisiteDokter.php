...
class SendKepatuhanVisiteDokter extends Command
{
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan waktu visite dokter...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepatuhanWaktuVisiteDokter::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepatuhan_waktu_visite_dokter', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Waktu Visite Dokter';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Waktu Visite Dokter')->firstOrFail();
