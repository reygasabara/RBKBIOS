        ...
        <div class="box" style="position: relative">
            @if ($notifikasi)
                <div id="errorContainerBox" class=""
                    ...
                    onclick="closeButton()">
                    <div class="bg-danger" style="width:50%; height:auto; margin:auto; padding: 20px; position: relative;">
                ...
                <div class="box-tools">
                    <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-btn">
                            <a href="/penerimaan/input" class="btn btn-success">Input</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-body"">
                <table class="table-dark table" id="table" style="z-index: -1;"">
                    <thead>
                        <tr>
