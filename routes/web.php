...
Route::middleware(['auth', 'web', 'permission:edit penerimaan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit pengeluaran'])->group(function () {
...
Route::middleware(['auth', 'permission:edit saldo - operasional'])->group(function () {
...
Route::middleware(['auth', 'permission:edit saldo - pengelolaan kas'])->group(function () {
...
Route::middleware(['auth', 'permission:edit saldo - dana kelolaan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah dokter spesialis'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah dokter gigi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah dokter umum'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah tenaga perawat'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah tenaga bidan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah pranata laboratorium'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah radiografer'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah ahli gizi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah fisioterapis'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah apoteker'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah tenaga profesional lainnya'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah tenaga non-medis'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah tenaga non-medis administrasi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah sanitarian'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah pasien rawat inap'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah pasien rawat darurat'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah layanan laboratorium (sampel)'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah layanan laboratorium (parameter)'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah tindakan operasi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah layanan radiologi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah layanan forensik'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah kunjungan rawat jalan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah pasien rawat jalan/poli'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah pasien BPJS/Non-BPJS'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah layanan farmasi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit BOR'])->group(function () {
...
Route::middleware(['auth', 'permission:edit TOI'])->group(function () {
...
Route::middleware(['auth', 'permission:edit ALOS'])->group(function () {
...
Route::middleware(['auth', 'permission:edit BTO'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah pelayanan dokpol'])->group(function () {
...
Route::middleware(['auth', 'permission:edit indeks kepuasan masyarakat'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah visite pasien di bawah jam 10'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah visite pasien jam 10 s.d 12'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah visite pasien di atas jam 12'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah DPJP tidak visite'])->group(function () {
...
Route::middleware(['auth', 'permission:edit jumlah visite pertama'])->group(function () {
...
Route::middleware(['auth', 'permission:edit rasio POBO'])->group(function () {
...
Route::middleware(['auth', 'permission:edit pertumbuhan realisasi pendapatan dari pengelolaan  aset BLU'])->group(function () {
...
Route::middleware(['auth', 'permission:edit penyelenggaraan RME'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan pelaksanaan protokol kesehatan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit persentase pembelian alkes produksi dalam negeri'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepuasan pasien'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan waktu visite DPJP'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan kebersihan tangan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan penggunaan APD'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan identifikasi pasien'])->group(function () {
...
Route::middleware(['auth', 'permission:edit waktu tanggap operasi seksio sesarea emergensi'])->group(function () {
...
Route::middleware(['auth', 'permission:edit waktu tunggu rawat jalan'])->group(function () {
...
Route::middleware(['auth', 'permission:edit penundaan operasi elektif'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan waktu visite dokter'])->group(function () {
...
Route::middleware(['auth', 'permission:edit pelaporan hasil kritis laboratorium'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan penggunaan fornas'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan alur klinis'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kepatuhan upaya pencegahan resiko pasien jatuh'])->group(function () {
...
Route::middleware(['auth', 'permission:edit kecepatan waktu tanggap komplain'])->group(function () {
