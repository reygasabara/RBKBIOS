...
class IndeksKepuasanMasyarakatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layers.indeks-kepuasan-masyarakat.index',["datas"=>$datas, 'active'=>['layanan', 'ikm'], "updated"=>$updated, "lastUpdate"=>$lastUpdate]);
    }
