...
class SendKepatuhanAlurKlinis extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:kepatuhan-alur-klinis';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepatuhan terhadap alur klinis (clinical pathway)...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepatuhanAlurKlinis::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepatuhan Terhadap Alur Klnis (Clinical Pathway)';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepatuhan Terhadap Alur Klnis (Clinical Pathway)')->firstOrFail();
