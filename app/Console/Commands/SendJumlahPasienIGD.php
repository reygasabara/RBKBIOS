...
class SendJumlahPasienIGD extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-pasien-igd';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah pasien rawat darurat ...';
    ...
    public function handle()
    {
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/pasien_igd', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Jumlah Pasien Rawat Darurat';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Pasien Rawat Darurat')->firstOrFail();
