...
class SendKepuasanPasien extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:kepuasan-pasien';
     ...
     * @var string
     */
    protected $description = 'Mengirim data kepuasan pasien...';
    ...
    public function handle()
    {
        ...
        $datas = IktKepuasanPasien::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/kepuasan_pasien', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Kepuasan Pasien';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Kepuasan Pasien')->firstOrFail();
