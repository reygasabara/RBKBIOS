...
class SendAhliGizi extends Command
{
    ...
    public function handle()
    {
        ...
        $datas = SdmAhliGizi::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $log->modul = 'SDM';
            $log->jenis_data = 'Jumlah Ahli Gizi';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Ahli Gizi')->firstOrFail();
