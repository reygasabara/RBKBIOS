    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Form Kepatuhan Pelaksanaan Protokol Kesehatan</h3>
            </div>

            <form role="form" method="POST" action="/kepatuhan-pelaksanaan-prokes/submit">
                @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{ old('jumlah') }}" id="jumlah" name="jumlah"
                            placeholder="Masukkan nilai pelaksanaan kepatuhan" required>
                    </div>
                </div>
