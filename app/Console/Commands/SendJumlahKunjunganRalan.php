...
class SendJumlahKunjunganRalan extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:jumlah-kunjungan-ralan';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah kunjungan rawat jalan/poli';
    ...
    public function handle()
    {
        ...
        $datas = LayananKunjunganRajal::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/layanan/pasien_ralan', $data);
            ...
            $log->modul = 'Layanan';
            $log->jenis_data = 'Jumlah Kunjungan Rawat Jalan';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Kunjungan Rawat Jalan')->firstOrFail();
