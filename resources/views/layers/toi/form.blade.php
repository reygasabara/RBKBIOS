    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Form TOI (Turn Over Interval)</h3>
            </div>

            <form role="form" method="POST" action="/toi/submit">
                @csrf
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="any" class="form-control" value="{{ old('toi') }}" id="toi"
                            name="toi" placeholder="Masukkan TOI dalam satuan hari" required>
                    </div>
                </div>
