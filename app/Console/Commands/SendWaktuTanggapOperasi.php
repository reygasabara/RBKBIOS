...
class SendWaktuTanggapOperasi extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:waktu-tanggap-operasi';
     ...
     * @var string
     */
    protected $description = 'Mengirim data waktu tanggap operasi seksio sesarea emergensi...';
    ...
    public function handle()
    {
        ...
        $datas = IktWaktuTanggapOperasi::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/waktu_tanggap_operasi_seksio_sesarea', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Waktu Tanggap Operasi Seksio Sesarea Emergensi';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Waktu Tanggap Operasi Seksio Sesarea Emergensi')->firstOrFail();
