...
class SendPembelianAlkes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:pembelian-alkes';
     ...
     * @var string
     */
    protected $description = 'Mengirim data persentase pembelian alat kesehatan produksi dalam Negeri...';
    ...
    public function handle()
    {
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/pembelian_alkes_dalam_negeri', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Persentase Pembelian Alat Kesehatan Produksi Dalam Negeri')->firstOrFail();
