...
class SendPenyelenggaraanRme extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:penyelenggaraan-rme';
     ...
     * @var string
     */
    protected $description = 'Mengirim data penyelenggaraan rekam medis elektronik...';
    ...
    public function handle()
    {
        ...
        $datas = IktPenyelenggaraanRme::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/penyelenggaraan_erm', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Penyelenggaraan Rekam Medis Elektronik';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Penyelenggaraan Rekam Medis Elektronik')->firstOrFail();
