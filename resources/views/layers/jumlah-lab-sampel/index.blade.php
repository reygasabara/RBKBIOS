    ...
    <section class="content">
        <div class="box" style="position: relative">
            <div class="box-header with-border">
                <h3 class="box-title">Jumlah Layanan Laboratorium (Sampel)</h3>
                <div class="box-tools">
                    <div class="input-group input-group-sm" style="width: 50px;">
                        <div class="input-group-btn">
                            <a href="/lab-sampel/input" class="btn btn-success">Input</a>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach ($datas as $key => $data)
                            <tr>
                                ...
                                <td>{{ $data['jumlah'] }}</td>
                                <td><a href="lab-sampel/delete/{{ $data['id'] }}" class="btn btn-danger"
