...
class BORController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layers.bor.index',["datas"=>$datas, 'active'=>['layanan', 'bor'], "updated"=>$updated, "lastUpdate"=>$lastUpdate]);
    }
