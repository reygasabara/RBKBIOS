...
class SendVisiteDiatasJam12 extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'send:visite-diatas-jam-12';
     ...
     * @var string
     */
    protected $description = 'Mengirim data jumlah visite di atas jam 12.00...';
    ...
    public function handle()
    {
        ...
        $datas = IktVisiteDiatas12::whereDate('tgl_transaksi', $targetDate)->get();
        $statusPengiriman = [];
        ...
        foreach ($datas as $data) {
            ...
            $response = Http::withHeaders(['token' => $token])->post('Https://' . env('DOMAIN_NAME') . '.kemenkeu.go.id/api/ws/kesehatan/ikt/visite_3', $data);
            ...
            $log->modul = 'IKT';
            $log->jenis_data = 'Jumlah Visite Pasien di Atas Jam 12.00';
        ...
        $selectedData = StatusPengiriman::Where('jenis_data', 'Jumlah Visite Pasien di Atas Jam 12.00')->firstOrFail();
